    ...
    <div class="col-lg-8">
        <div class="ibox">
            <div class="ibox-title">
                <h5><span class="fa fa-search"></span> Cari BKU</h5>
            </div>
            <div class="ibox-content highlight-bas">
                <form method="post" action="<?php echo base_url('bku/buku_kas_umum') ?>">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select id="koderekening" class="select2" style='width: 400px;' name="selectDesa" required="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select id="electBulan" class="selectBulan" name="bulan" style='width: 200px;' required="">
                                <option value="" <?php if ($rs_input['bulan'] == 0): ?> selected="selected"<?php endif ?>>-- Pilih Bulan --</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <button type="submit" class="btn btn-primary dim">Tampilkan</button>
                        </div>
                    </div>
                    <br>
                </form>
...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-title">
                <h5><span class="fa fa-files-o"></span> Daftar BKU</h5>
            </div>
            <div class="ibox-content border-bottom highlight-bas">
                ...
                <?php if ($this->session->hakakses == 'ADMIN' OR $this->session->hakakses == 'OPERATORDESA'): ?>            
                    <div class="input-group-btn ">
                        <?php if ($rs_input['koderekening'] == ""): ?>
                            <button data-toggle="dropdown" class="btn btn-success dropdown-toggle dim" type="button" aria-expanded="true" disabled>Tambah <span class="caret"></span></button>
                        <?php else: ?>
                            <button data-toggle="dropdown" class="btn btn-success dropdown-toggle dim" type="button" aria-expanded="true">Tambah <span class="caret"></span></button>
                        <?php endif ?>                   
                        <ul class="dropdown-menu pull-right highlight-bas">
                            <li><a href="#" data-target="#modalSPJPenerimaan" data-toggle="modal" id="addPenerimaan">SPJ Penerimaan</a></li>
                            <li class="divider"></li>
                            <li><a href="#" data-target="#modalSPJ" data-toggle="modal" id="addPengeluaran">SPJ Pengeluaran</a></li>
                            <li class="divider"></li>
                            <li><a href="#" data-target="#modalPajak" data-toggle="modal" id="addPajak">Pajak</a></li>
                            <li class="divider"></li>
                            <li><a href="#" data-target="#modalPergeseran" data-toggle="modal" id="addPergeseran">Pergeseran</a></li>  
                        </ul>
                    </div>
                    <?php endif ?>
                </div>
                ...
                <div class="table-responsive ">
                    <div class='dataTables_wrapper form-inline dt-bootstrap no-footer '>
                        <table class="table table-bordered highlight-bas" id="datatablebku">
                            <thead>
                                <tr>                                    
                                    <th>No BKU</th>
                                    <th>Tanggal BKU</th>
                                    ...
                                    <tr>                                    
                                        ...
                                        <td align="center" width="15%">                                        
                                            ...
                                            <?php elseif ($result['JENIS_BKU'] == 'PENERIMAAN'): ?>
                                                <a href="#" data-id="<?php echo $result['NO_BKU'] . '|' . $result['BUKTI'] . '|' . $result['JENIS_BKU'] . '|' . $result['URAIAN'] . '|' . number_format($result['PENERIMAAN'], 0, ",", ".") . '|' . number_format($result['PENGELUARAN'], 0, ",", ".") . '|' . date("d/m/Y", strtotime($result['TGL_BKU'])) . '|' . date("d/m/Y", strtotime($result['TGL_BUKTI'])) . '|' . $result['SIMPANANBANK'] ?>" data-target="#modalEditPenerimaan" data-toggle="modal" class="btn btn-primary btn-xs bd-rad-0" id="ubah_spj_penerimaan" data-placement="bottom" title="Ubah"><span class="glyphicon glyphicon-pencil"></span></a>
                                            <?php else: ?>
        ...
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/add_spj_penerimaan') ?>" method="post">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><span class="fa fa-files-o"></span> Form Tambah SPJ Penerimaan</h4>
                </div>
                    ...
                    <div class="row">                        
                        <div class="form-group"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control idnobku" id="bukti_penerimaan" placeholder="No Bukti" name="no_bukti" required
                                       oninvalid="this.setCustomValidity('Nomer Bukti SPJ harus diisi !!')" onchange="this.setCustomValidity('')" />
                                        <small><i>* Jika Nomor BKU Muncul Dikolom List Maka Nomor BKU Tersebut Telah Digunakan</i></small>
                                <br>
                                <div class="radio radio-success radio-inline">
                                    <input type="radio" id="inlineRadio1" value="simpanan_bank" name="radioInline" checked="checked">
                                    <label for="inlineRadio1">SIMPANAN-BANK</label>                                    
                                </div>
                                <div class="radio radio-success radio-inline">                                   
                                    <input type="radio" id="inlineRadio2" value="kas_tunai" name="radioInline">
                                    <label for="inlineRadio2">KAS-TUNAI</label>
                                </div><br>
                                <label>Uraian</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="simpan btn btn-primary dim"> <span class="fa fa-save"></span> Simpan</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/edit_spj_penerimaan') ?>" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title"><span class="fa fa-pencil"></span> Form Ubah SPJ Penerimaan</h4>
                </div>
                <div class="modal-body highlight-bas">
                    <div class="row">                        
                        <div class="form-group"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <br>
                                <div class="radio radio-success radio-inline">
                                    <input type="radio" id="inlineRadio1" value="simpanan_bank" name="radioInline">
                                    <label for="inlineRadio1">SIMPANAN-BANK</label>                                    
                                </div>
                                <div class="radio radio-success radio-inline">                                   
                                    <input type="radio" id="inlineRadio2" value="kas_tunai" name="radioInline">
        ...
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/add_spj_penerimaan') ?>" method="post">
                ...
                <div class="modal-body highlight-bas">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger dim" data-dismiss="modal"><span class="fa fa-times"></span> Batal</button>
                        <button type="button" class="simpan btn btn-primary dim" onclick="pilihEditRekening()"><span class="fa fa-check"></span> Pilih</button>
                    </div>
                </div> 
            </form>
        </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/add_spj') ?>" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel"><span class="fa fa-files-o"></span> Form Tambah SPP BKU</h4>
                </div>
                <div class="modal-body highlight-bas ">
                    <div class="row">                        
                        <div class="form-group"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="nospp form-control" style='width: 100%;' name="selectspp" id="selectspp" onchange="ambilnospp()" required>
                                    <option value="0">Pilih Bukti </option>
                                </select>                                

                                <label>Uraian</label>
                                <textarea type="text" class="form-control" id="uraian_spj_pengeluaran" style="width:100%;" rows="5" name="uraian" required oninvalid="this.setCustomValidity('Uraian harus diisi !!')" onchange="this.setCustomValidity('')"></textarea>                                                    
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td align="right"><b><input type="text" id="totalPajak" style="border:0;background:transparent;text-align: right; " readonly="true"></b></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                    ...
                    <table class="table table-bordered table-stripted">
                        ...
                        <tfoot>
                            <tr>
                                <td><strong>Jumlah</strong></td>
                                <td>&nbsp</td>
                                <td align='right'><strong id="jumlah_pagu">0,00</strong><input type="hidden" name="jumlah_all_pagu" id="jumlah_all_pagu" value="0,00" ></td>
                                <td align='right'><strong id="jumlah_all_spj">0,00</strong><input type="hidden" name="jumlah_all_terima" id="jumlah_all_terima_spj" value="0,00" ></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>                
                                ...
                                <div class="table-responsive" >
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="2"><b>Jumlah</b></td>
                                                <td align="right"><b><input type="text" id="totalPajakEdit" style="border:0;background:transparent;text-align: right; " readonly="true"></b></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/add_pajak') ?>" method="post"> 
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel"><span class="fa fa-files-o"></span> Tambah Pungut Pajak</h4>
                </div>
                <div class="modal-body highlight-bas">
                    <div class="row">                        
                        <div class="form-group"> 
                            ...
                            <div class="col-md-8" style="width: 60%;">
                                ...
                                <select name="jenisPajak" class="form-control" style="width:100%;" id="jenisPajak">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <!--                                        <button class="btn btn-default" type="button" id="setor_bukti" disabled="disabled">
                                                                                    <span class="glyphicon glyphicon-search"></span>
                                                                                </button>-->
                                        <a href="#" data-target="#modal_setor_pajak" data-toggle="modal" class="btn btn-default disabled" id="setor_bukti" data-placement="bottom" title="Cari Bukti" style="float: right;">
                                            <span class="glyphicon glyphicon-search"></span>
                                        </a>
                                    </span>
                                </div>
                                ...
                                <table class="table table-bordered table-stripted" id="table_pajak">
                                    <thead>
                                        <tr>
                                            <th width="25%">Kode</th>
                                            <th>Urai Rekening</th>
                                    ...
                                    <tbody id="data_pajak">
                                        <tr>
                                            <td align="left" id="rekening_pajak">
                                                <a href="#" data-target="#modal_kode_pajak" data-toggle="modal" class="btn btn-primary btn-xs bd-rad-0" data-placement="bottom" title="Cari Rekening" style="float: right;"><span class="glyphicon glyphicon-search"></span></a>
                                            </td>
                                            <td id="urai_pajak">&nbsp</td>
                                            <td id="jml_pajak">&nbsp</td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <td><strong>Jumlah</strong></td>
                                            <td>&nbsp</td>
                                            <td align='right' id='total_pajak'><strong id="jumlah_pajak_all">0</strong><input type="hidden" name="jumlah_all_pajak" id="jumlah_all_pajak" value="0" ></td>
                                        </tr>
                                    </tfoot>
                                </table>                                                  
                            </div>                                    
...
<!-- Modal Setor Pajak -->
<div class="modal fade bs-example-modal-lg" id="modal_setor_pajak">
    <div class="modal-dialog modal-xl" style="width: 65%;">
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/add_setor_pajak') ?>" method="post">
                <?php foreach ($pungut_pajak as $ppajak): ?>
                <input type="hidden" value="<?php echo $ppajak['XTAHUN']; ?>" name="tahun" id="tahun_pajak"> 
                <input type="hidden" value="<?php echo $ppajak['XKODEURUSAN']; ?>" name="kodeurusan" id="urusan_pajak"> 
                <input type="hidden" value="<?php echo $ppajak['XKODESUBURUSAN']; ?>" name="kodesuburusan" id="suburusan_pajak"> 
                <input type="hidden" value="<?php echo $ppajak['XKODEORGANISASI']; ?>" name="kodeorganisasi" id="organisasi_pajak"> 
                <input type="hidden" value="<?php echo $ppajak['XKODEDESA']; ?>" name="kodedesa" id="desa_pajak"> 
                <?php endforeach ?>
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title">Pilih Bukti Pajak</h4>
                </div>
                <div class="modal-body highlight-bas">
                    <div class="row">
                        <table class="table table-bordered table-stripted header-fixed tableRekeningPajak">
                            <thead>
                                <tr>
                                    <th width="15%">No BKU</th>
                                    <th width="20%">Tgl BKU</th>
                                    <th width="20%">Bukti</th>
                                    <th width="20%">Tgl Bukti</th>
                            ...
                            <tbody>
                                <?php foreach ($pungut_pajak as $pp): ?>
                                    <tr>
                                        <td width="15%"><?php echo $pp['NO_BKU']; ?></td>
                                        <td width="20%"><?php echo date("d-M-Y", strtotime($pp['TGL_BKU'])) ?></td>
                                        <td width="20%"><?php echo $pp['BUKTI']; ?></td>
                                        <td width="20%"><?php echo date("d-M-Y", strtotime($pp['TGL_BUKTI'])) ?></td>
                                        <td width="20%"><?php echo $pp['ORGANISASI']; ?></td>
                                        <td width="20%" nowrap><?php echo $pp['URAIAN']; ?></td>
                                        <!-- <td>0</td> -->
                                    </tr>
                                <?php endforeach ?>
                            </tbody>                            
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger dim" data-dismiss="modal"><span class="fa fa-times"></span> Batal</button>
                        <button type="button" class="simpan btn btn-primary dim" id="pilihPungutPajak"><span class="fa fa-check"></span> Pilih</button>
                    </div>
                </div> 
            </form>
        </div>
...
<!-- Modal Kode Pajak -->
<div class="modal fade bs-example-modal-lg" id="modal_kode_pajak">
    <div class="modal-dialog modal-xl" style="width: 65%;">
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/add_pajak') ?>" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body highlight-bas">
                    <div class="row">
                        <table class="table table-bordered table-stripted header-fixed tableRekeningPajak">
                            <thead>
                                <tr>
                                    <th width="15%" class="kodeRek">Kode</th>
                                    <th width="60%" class="uraiRek">Urai Rekening</th>
                                    <th width="25%" class="singkatRek">Singkat</th>
                                    <!-- <th>Jumlah</th> -->
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($master_pajak as $result): ?>
                                    <tr>
                                        <td width="15%"><?php echo $result['KODEAKUN'] . '.' . $result['KODEKELOMPOK'] . '.' . $result['KODEJENIS'] . '.' . $result['KODEOBJEK']; ?></td>
                                        <td width="60%"><?php echo $result['URAI']; ?></td>
                                        <td width="25%" nowrap><?php echo $result['SINGKAT']; ?></td>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger dim" data-dismiss="modal"><span class="fa fa-times"></span> Batal</button>
                        <button type="button" class="simpan btn btn-primary dim" id="pilihRekeningPajak"><span class="fa fa-save"></span> Pilih</button>
                    </div>
                </div> 
            </form>
        </div>
                    ...
                    <div class="row">
                        <div class="form-group"> 
                            ...
                            <div class="col-md-8" style="width: 60%;">
                                ...
                                <label>Jenis Pajak</label>
                                <table class="table table-bordered table-stripted" id="table_edit_pajak">
                                    <thead>
                                        <tr>
                                            <th width="25%">Kode</th>
                                            <th>Urai Rekening</th>
                                    ...
                                    <tbody id="data_edit_pajak">
                                        <tr>
                                            <td align="left" id="kd_edit_rek">
                                                <a href="#" data-target="#modal_edit_kode_pajak" data-toggle="modal" class="btn btn-primary btn-xs bd-rad-0" data-placement="bottom" title="Cari Rekening" style="float: right;"><span class="glyphicon glyphicon-search"></span></a>
                                            </td>
                                            <td id="urai_edit_rek">&nbsp</td>
                                            <td id="jml_edit_rek">&nbsp</td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <td><strong>Jumlah</strong></td>
                                            <td>&nbsp</td>
                                            <td align='right' id='total_edit_pajak'><strong id="jumlah_edit_pajak_all">0</strong><input type="hidden" name="jumlah_all_edit_pajak" id="jumlah_all_edit_pajak" value="0" ></td>
                                        </tr>
                                    </tfoot>
                                </table>                                                  
                            </div>                                   
...
<!-- Modal edit Kode Pajak -->
<div class="modal fade bs-example-modal-lg" id="modal_edit_kode_pajak">
    <div class="modal-dialog modal-xl" style="width: 65%;">
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/add_pajak') ?>" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body highlight-bas">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger dim" data-dismiss="modal"><span class="fa fa-times"></span> Batal</button>
                        <button type="button" class="simpan btn btn-primary dim" id="pilihRekeningEditPajak"><span class="fa fa-save"></span> Pilih</button>
                    </div>
                </div> 
            </form>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?php echo base_url('bku/buku_kas_umum/add_pergeseran') ?>" method="post"> 
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel"><span class="fa fa-files-o"></span> Tambah Pergeseran</h4>
                </div>
                <div class="modal-body highlight-bas">            
                    <div class="row">                        
                        <div class="form-group"> 
                            ...
                            <div class="col-md-8" style="width: 60%;">
                                ...
                                <input type="text" class="form-control" id="no_bku" value="<?php echo $nobku; ?>" name="no_bku" required 
                                       oninvalid="this.setCustomValidity('Nomer BKU harus diisi !!')" onchange="this.setCustomValidity('')" readonly>
                                <label>No Bukti</label>
                                <input type="text" class="form-control idnobku" id="no_bukti" placeholder="No Bukti" name="no_bukti" required
                                       oninvalid="this.setCustomValidity('Nomer Bukti harus diisi !!')" onchange="this.setCustomValidity('')">
                                <!--                                <label>Jenis</label><br>
                                ...
                                <label>Uraian</label>
                                <textarea type="text" class="form-control" id="uraian_pergeseran" style="width:100%;" name="uraian" required oninvalid="this.setCustomValidity('Uraian harus diisi !!')" onchange="this.setCustomValidity('')"></textarea>
                                <label>Jumlah</label>
                                <!-- <input type="text" class="form-control amount_format" id="add_jumlah"  style="text-align:right;" name="jumlah" required
                                       oninvalid="this.setCustomValidity('Jumlah harus diisi !!')" onchange="this.setCustomValidity('')"> -->
                              ...
                              <input type="text" class="form-control" id="add_jumlah" name="jumlah" onkeydown="return numbersonly(this, event);" required onkeyup="javascript:tandaPemisahTitik(this);" oninvalid="this.setCustomValidity('Jumlah harus diisi !!')" onchange="this.setCustomValidity('')" placeholder="0,00">
                            </div>                                    
                            <div class="col-md-offset-4">
                                <label>Tgl BKU</label>
                                <div class='input-group date'>
                    ...
                    <div class="row">                        
                        <div class="form-group"> 
                            ...
                            <div class="col-md-8" style="width: 60%;">
                                ...
                                <label>Jumlah</label>
                                <input type="text" class="form-control amount_format" id="edit_jumlah" placeholder="0,00" style="text-align:right;" name="jumlah" required
                                       oninvalid="this.setCustomValidity('Jumlah harus diisi !!')" onchange="this.setCustomValidity('')">
                                <!--                                <label>Penerimaan</label>
